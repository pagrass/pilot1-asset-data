...
Output structure under structuralsimilarity_pilot2/:
...
CDN_BASE  = "https://cdn.jsdelivr.net/gh/pagrass/pilot1-asset-data@latest/structuralsimilarity_pilot2/crypto/current/"
...
def git_commit_and_push(repo_root, paths_to_add, branch="main"):
    ...
    try:
        ...
        msg = f"structuralsimilarity_pilot2: update crypto data {datetime.now().strftime('%Y-%m-%d %H:%M')}"
...
def main():
    ...
    print("=" * 50)
    print("FETCHING CRYPTO PRICE DATA (structuralsimilarity_pilot2)")
    print("=" * 50)
    ...
    for slug in CRYPTOS.values():
        print(f"  curl -s https://purge.jsdelivr.net/gh/pagrass/pilot1-asset-data@latest/structuralsimilarity_pilot2/crypto/current/{slug}_365d.json")
