#!/usr/bin/env python3
"""
Fetch crypto data for the Investment Decisions PILOT 2 (Wave 1).
...
Output structure under decisions_pilot2/:
...
def git_commit_and_push(repo_root, paths_to_add, branch="main"):
    ...
    try:
        ...
        msg = f"decisions_pilot2: update crypto data {datetime.now().strftime('%Y-%m-%d %H:%M')}"
...
def main():
    ...
    print("=" * 50)
    print("FETCHING CRYPTO PRICE DATA (decisions_pilot2)")
    print("=" * 50)
